                ...
                members: {
                    ...
                    init_settingsWnd: function () {
                        try {
                            ...
                            this.settingsWnd.add(this.swObj.allianceSelect, {
                                row: 1,
                                column: 1
                            });

                            this.refreshIcon = new qx.ui.basic.Image("FactionUI/icons/icon_refresh_funds.png");
                            this.settingsWnd.add(this.refreshIcon, {
                                row: 1,
                                column: 2
                            });
                            ...
                            btnZoomIn.addListener("click", function () {
                                if (isNaN(this.visOptions.settingsPanel.zoomFactor)) this.visOptions.settingsPanel.zoomFactor = 3;
                                //increment +0.2
                                this.visOptions.settingsPanel.zoomFactor =

                                    //Math.round((this.visOptions.settingsPanel.zoomFactor + 0.2) * 10) / 10;
                                    (parseFloat(this.visOptions.settingsPanel.zoomFactor) + 0.2).toFixed(1);
